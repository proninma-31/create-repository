...
Чтобы добавить цитату необходимо добавить символ > например
...
так же можно делать несколько уровней цитат на пример
...
Чтобы сделать строку для ввода кода необходимо поставить сверху и снизу текста ~~~ на пример 
...
Добавить новую информацию из удаленного репозитория гитхаб

Добавляю новую информацию из локального в удаленный репозиторий